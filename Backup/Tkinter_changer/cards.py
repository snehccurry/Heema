...
class card():
    ...
    def __init__(self, frame_name, title="your title here",description="your description here",image="images\\image1.png",x=100,y=70):
        label_frame_for_card=LabelFrame(frame_name,bg="red",bd=2,fg=label_fg,width=100,height=50)
        ...
        self.label = tk.Label(
            ...
            text = title, 
            fg = "#ffffff", 
            bg = self.varBG,justify="left", 
            font = (self.varFont, self.fontSize),
            wraplength=150
            )
        
        self.description=tk.Label(sub_frame,text=description, justify="left",wraplength=250,fg="#999999",bg=label_bg,font=(self.varFont,int(self.fontSize*0.70)))
        #self.label.pack()
