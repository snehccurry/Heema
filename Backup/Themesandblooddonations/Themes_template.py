...
r= IntVar()
r.set(3)
a=LabelFrame(bg="#202020",fg="#999999",bd=1)
...
a1=Radiobutton(a, text="Cool PC at once",bg="#202020",activebackground="#003333",fg="#009999",font=("Orbitron",14),  variable=r, value=1,command= lambda: clicked(r.get())).pack(side = BOTTOM, pady=1)
