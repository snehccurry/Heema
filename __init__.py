...
class SwitchButton(Button):
    def __init__(self, *args, on_click=None, **kwargs):
        ...
        self._state = "on"
        self.configure(bd=label_bd,activebackground=self.master.cget("background"),activeforeground=self.master.cget("background"),background=self.master.cget("background"))  # Set button background to root's background
